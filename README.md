...
First, add `flutter_zoom: ^1.0.0` as a [dependency in your pubspec.yaml file](https://flutter.io/using-packages/).

After running pub get, you must run the follow script to get Zoom SDK for the first time:

Download sdk files from google drive the find flutter_zoom your pc the add files in following paths

Android Files :
flutter_zoom/android/libs/
